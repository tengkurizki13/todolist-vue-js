...
<template>
  ...
  <div class="container" @click="changeElementOutInput">
      ...
      <div class="jss18">
        <div class="jss25 jss26 jss20">
          <div class="jss25">
            ...
            <input type="text" class="form-control border-0  bg-transparent input-h1-size" v-model="activity.title" @change="handleInputChange" v-if="isUpdateTitle"  ref="inputElement"/>
